...
16:9 2K wallpaper. Referring to the attached image (Figure 1), generate a similar style close-up portrait of Nangong Yu from Zenless Zone Zero.
...
![alt text](qianxia-base.png)

16:9 2K wallpaper. Referring to the attached image (Figure 1), generate a similar style image for Sunna from Zenless Zone Zero on the same KFC-themed idol stage.
...
16:9 2K wallpaper. Referring to the attached image (Figure 1), generate a similar style image for Sunna working at a KFC × Delusion Angels themed pop-up cafe.
...
16:9 2K wallpaper. Referring to the attached image (Figure 1), generate a similar style group image featuring Nangong Yu, Aria, and Sunna from Zenless Zone Zero together on the KFC idol stage.
