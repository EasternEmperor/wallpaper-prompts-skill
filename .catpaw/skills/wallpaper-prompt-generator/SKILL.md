...
1. **米哈游官方**（最高优先级）：米游社官方公告、HoYoLab、各游戏官网 → 版本更新、前瞻直播、新角色发布、活动开启
2. **社区热度**：B站、小红书、米游社讨论区 → 角色讨论量、同人创作趋势、热门话题
3. **角色人气榜**：各游戏官方/社区人气投票、抽卡意愿调查
4. **时事热点**：节日（春节/七夕/中秋等）、赛事（世界杯/ChinaJoy等）、季节变化

搜索关键词参考：`原神 最新版本 新角色`、`绝区零 版本更新`、`崩坏星穹铁道 新角色`、`Genshin Impact update`、`Zenless Zone Zero new character`
...
- 官方立绘 splash art（米游社、官网）
- 卡池抽卡立绘 gacha art
- 已有的高质量同人壁纸（作为构图参考）

下载方式：优先用浏览器访问米游社等站点提取高清图片 URL，再 curl 下载。下载后在 prompts.md 中用 `![alt text](filename.png)` 引用。

### 跨领域参考图（类型 A 专用）

根据角色的**职业、身份、技能特点**，从真实世界中寻找对应领域的高质量参考素材（照片、名画、海报等），下载到角色目录，并编写融合 prompt。核心价值：将真实世界的专业美学注入游戏角色，产出更有艺术感和独特性的壁纸。

**角色职业 → 参考素材映射示例**：

| 角色职业/特质 | 搜索方向 | 参考素材类型 |
|---------------|----------|-------------|
| 芭蕾舞者 | 天鹅湖演出照、芭蕾海报、德加名画 | 舞姿照片、印象派油画 |
| 剑士/武者 | 剑道比赛照、武士电影海报、浮世绘 | 动作摄影、日本古典版画 |
| 弓箭手 | 射箭运动摄影、阿尔忒弥斯雕塑 | 运动摄影、古典雕塑 |
| 歌者/偶像 | 演唱会舞台照、音乐剧海报 | 舞台摄影、演出海报 |
| 厨师 | 米其林大厨肖像、美食摄影 | 人物肖像、环境摄影 |
| 医生/学者 | 文艺复兴时期学者画像、实验室摄影 | 古典肖像画、科研摄影 |
| 侦探/间谍 | 黑色电影海报、noir 风格摄影 | 电影海报、noir 摄影 |
| 海盗/航海 | 浪漫主义海洋绘画、航海摄影 | 透纳海景油画、帆船摄影 |
